        ...
        <div className={styles.contact__box}>
          ...
          <div className={styles.contact__right}>
            ...
            <form className={styles.contact__form}>
              ...
              <textarea placeholder="Ваше сообщение" className={styles.contact__input} name="" id="" cols="30" rows="10"></textarea>
              </div>
              <button className={styles.contact__btn} type="submit">Отправить</button>
            </form>
          </div>
        </div>
      </Container>
